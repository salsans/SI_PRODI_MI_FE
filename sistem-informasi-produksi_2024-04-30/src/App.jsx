...
import MasterKategori from "./component/page/master-kategori/Root"; // Import MasterKategori
import MasterAbsen from "./component/page/master-absen/Root"; // Import MasterAbsen
...
export default function App() {
  ...
  else if (isSignupPage) return <MasterCustomerAddd />;
            ...
            <div className="d-flex flex-row">
              ...
              <Container>
                <RouterProvider router={createBrowserRouter([
                  { path: "/master-kategori", element: <MasterKategori /> }, // Rute MasterKategori
                  { path: "/master-absen", element: <MasterAbsen /> }, // Rute MasterAbsen
                  ...listRoute // Menyertakan rute lain
                ])} />
              </Container>
            </div>
          </>
